...
`.claude/orchestration/`, then use the Exa-informed optimization phases
...
- **Control-plane update:** `.claude/orchestration/CONTROL_PLANE.md`
  and `.claude/orchestration/TPU_OPTIMIZATION_SPEC.md` are the new
...
- [x] `.claude/VERIFY.md` passes on the workstation.
