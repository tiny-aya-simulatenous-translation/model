---
name: tpu-doc-style
description: Apply the TinyAya Stage 2 TPU-for-GPU-engineers documentation style and run the project ruff lint workflow. Use when authoring or editing any Python under src/ or scripts/, when the user asks for "TPU docs", "lint pass", or "PEP8 + docstrings". Pairs with AGENTS.md "TPU code documentation style (mandatory)".
---
...
lives in `AGENTS.md`; this skill is a
...
4. **Inline comments** explain *trade-offs and gotchas*, never
   restate code. Cross-reference `.claude/memories.md` whenever the
...
# parse all YAML configs (gpu/ + tpu/)
